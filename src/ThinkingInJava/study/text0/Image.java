...
public class Image {
    ...
    public static void main(String[] args   ) throws IOException {
        Image i = new Image();
        String srcPath = "E:/a.jpg";
        String toPath = "E:/001.jpg";
        int x = 0;
        int y = 0;
        int width = 156;
        int height = 220 ;
...
//        i.cropImage(srcPath, toPath, x, y, width, height, readImageFormat, writeImageFormat);
        i.resizeImage("E:/b.jpg","E:/001.jpg",145,117);
        i.mergeBothImage(srcPath,toPath,6,46,"E:/obj.jpg");
    }
}
